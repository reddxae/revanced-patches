...
public class Settings extends BaseSettings {
    ...
    public static final StringSetting CUSTOM_SEEKBAR_COLOR_PRIMARY = new StringSetting("revanced_custom_seekbar_color_primary", "#FF0000", true, parent(ENABLE_CUSTOM_SEEKBAR_COLOR));
